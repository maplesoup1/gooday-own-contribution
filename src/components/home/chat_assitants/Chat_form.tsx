...
const help_assistent = () => {
    ...
    return (
        <div className='fixed top-0 right-6 w-[380px] h-[590px] bg-white
    shadow-lg rounded-sm overflow-auto'>
            ...
            <div className='text-sm text-center my-4'>
                <p>
                    ...
                    <a className='border-b border-yellow-300 text-yellow-300' href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
                    and
                    <a className='border-b  border-yellow-300 text-yellow-300' href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer">Terms of Service</a> apply.
                </p>
            </div>
        </div>
    )
